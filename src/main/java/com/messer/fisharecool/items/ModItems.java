...
public class ModItems {
    public static final Item IRON_FISH = registerItem("iron_fish",
            new Item(new FabricItemSettings().group(ItemGroup.MISC).food(FoodComponents.COD)));

    public static final Item COOKED_IRON_FISH = registerItem("cooked_iron_fish",
            new Item(new FabricItemSettings().group(ItemGroup.MISC).food(ModFoodComponents.COOKED_IRON_FISH)));
    ...
    public static final Item COOKED_COPPER_FISH = registerItem("cooked_copper_fish",
            new Item(new FabricItemSettings().group(ItemGroup.MISC).food(ModFoodComponents.COOKED_COPPER_FISH)));
    ...
    public static final Item COOKED_DIAMOND_FISH = registerItem("cooked_diamond_fish",
            new Item(new FabricItemSettings().group(ItemGroup.MISC).food(ModFoodComponents.COOKED_DIAMOND_FISH)));
    ...
    public static final Item COOKED_REDSTONE_FISH = registerItem("cooked_redstone_fish",
            new Item(new FabricItemSettings().group(ItemGroup.MISC).food(ModFoodComponents.COOKED_REDSTONE_FISH)));
    ...
    public static final Item COOKED_DEBRIS_FISH = registerItem("cooked_debris_fish",
            new Item(new FabricItemSettings().group(ItemGroup.MISC).food(ModFoodComponents.COOKED_DEBRIS_FISH)));
    ...
    public static final Item COOKED_EMERALD_FISH = registerItem("cooked_emerald_fish",
            new Item(new FabricItemSettings().group(ItemGroup.MISC).food(ModFoodComponents.COOKED_EMERALD_FISH)));
    ...
    public static final Item COOKED_LAPIS_FISH = registerItem("cooked_lapis_fish",
            new Item(new FabricItemSettings().group(ItemGroup.MISC).food(ModFoodComponents.COOKED_LAPIS_FISH)));
    ...
    public static final Item COOKED_QUARTZ_FISH = registerItem("cooked_quartz_fish",
            new Item(new FabricItemSettings().group(ItemGroup.MISC).food(ModFoodComponents.COOKED_QUARTZ_FISH)));
    ...
    public static final Item COOKED_AMETHYST_FISH = registerItem("cooked_amethyst_fish",
            new Item(new FabricItemSettings().group(ItemGroup.MISC).food(ModFoodComponents.COOKED_AMETHYST_FISH)));
    ...
    public static final Item COOKED_COAL_FISH = registerItem("cooked_coal_fish",
            new Item(new FabricItemSettings().group(ItemGroup.MISC).food(ModFoodComponents.COOKED_COAL_FISH)));
    ...
    public static final Item COOKED_GOLD_FISH = registerItem("cooked_gold_fish",
            new Item(new FabricItemSettings().group(ItemGroup.MISC).food(ModFoodComponents.COOKED_GOLD_FISH)));


    private static Item registerItem(String name, Item item){
        return Registry.register(Registry.ITEM, new Identifier(FishAreCool.MOD_ID, name), item);
    }
